...
| [P0 live MCP retest follow-up plan](improvements/p0_live_mcp_retest_followup_plan.md) | Remaining Hermes/Codex live-retest follow-ups for noisy real hubs, fact canonicalization, and MCP contract smoke coverage. |
